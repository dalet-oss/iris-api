...
// UpdateDHCPSubnetParams contains all the bound params for the update d h c p subnet operation
// typically these are obtained from a http.Request
//
// swagger:parameters UpdateDHCPSubnet
...
//
// To ensure default values, the struct must have been initialized with NewUpdateDHCPSubnetParams() beforehand.
func (o *UpdateDHCPSubnetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *UpdateDHCPSubnetParams) bindSubnetID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
