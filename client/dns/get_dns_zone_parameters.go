...
GetDNSZoneParams contains all the parameters to send to the API endpoint
	...
	for the get DNS zone operation.
...
// WithDefaults hydrates default values in the get DNS zone params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDNSZoneParams) WithDefaults() *GetDNSZoneParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get DNS zone params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDNSZoneParams) SetDefaults() {
