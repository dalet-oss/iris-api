...
func makeClient(cmd *cobra.Command, args []string) (*client.Iris, error) {
...
func registerAuthInoWriterFlags(cmd *cobra.Command) error {
	/*x-token */
	cmd.PersistentFlags().String("x-token", "", ``)
	viper.BindPFlag("x-token", cmd.PersistentFlags().Lookup("x-token"))
	return nil
}
...
func makeAuthInfoWriter(cmd *cobra.Command) (runtime.ClientAuthInfoWriter, error) {
	...
	/*x-token */
	if viper.IsSet("x-token") {
		XTokenKey := viper.GetString("x-token")
		auths = append(auths, httptransport.APIKeyAuth("x-token", "header", XTokenKey))
	}
	if len(auths) == 0 {
...
func makeOperationGroupDhcpCmd() (*cobra.Command, error) {
	...
	operationCreateDHCPSubnetCmd, err := makeOperationDhcpCreateDHCPSubnetCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationCreateDHCPSubnetCmd)

	operationCreateDHCPSubnetReservationCmd, err := makeOperationDhcpCreateDHCPSubnetReservationCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationCreateDHCPSubnetReservationCmd)

	operationDeleteDHCPSubnetCmd, err := makeOperationDhcpDeleteDHCPSubnetCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationDeleteDHCPSubnetCmd)

	operationDeleteDHCPSubnetReservationCmd, err := makeOperationDhcpDeleteDHCPSubnetReservationCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationDeleteDHCPSubnetReservationCmd)

	operationDisableDHCPCmd, err := makeOperationDhcpDisableDHCPCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationDisableDHCPCmd)

	operationEnableDHCPCmd, err := makeOperationDhcpEnableDHCPCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationEnableDHCPCmd)

	operationGetAllDHCPSubnetReservationsCmd, err := makeOperationDhcpGetAllDHCPSubnetReservationsCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationGetAllDHCPSubnetReservationsCmd)

	operationGetAllDHCPSubnetsCmd, err := makeOperationDhcpGetAllDHCPSubnetsCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationGetAllDHCPSubnetsCmd)

	operationGetDHCPStatusCmd, err := makeOperationDhcpGetDHCPStatusCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationGetDHCPStatusCmd)

	operationGetDHCPSubnetCmd, err := makeOperationDhcpGetDHCPSubnetCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationGetDHCPSubnetCmd)

	operationGetDHCPSubnetReservationCmd, err := makeOperationDhcpGetDHCPSubnetReservationCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationGetDHCPSubnetReservationCmd)

	operationReloadDHCPCmd, err := makeOperationDhcpReloadDHCPCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationReloadDHCPCmd)

	operationUpdateDHCPSubnetCmd, err := makeOperationDhcpUpdateDHCPSubnetCmd()
	if err != nil {
		return nil, err
	}
	operationGroupDhcpCmd.AddCommand(operationUpdateDHCPSubnetCmd)

	operationUpdateDHCPSubnetReservationCmd, err := makeOperationDhcpUpdateDHCPSubnetReservationCmd()
	if err != nil {
		return nil, err
	}
...
func makeOperationGroupOperationsCmd() (*cobra.Command, error) {
	...
	operationHealthzCmd, err := makeOperationOperationsHealthzCmd()
	if err != nil {
		return nil, err
	}
	operationGroupOperationsCmd.AddCommand(operationHealthzCmd)
